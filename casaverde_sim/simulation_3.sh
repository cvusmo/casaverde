...
SIM_PY="$PROJECT_ROOT/casaverde_sim/py/simulation_3.py"
...
# ---------------------------
# SOCAT - virtual serial ports (for Python sim to controller communication)
# ---------------------------
...
# ---------------------------
# PYTHON SIMULATION (simulation_3.py)
# ---------------------------
